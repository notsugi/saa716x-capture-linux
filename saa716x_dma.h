...
#define SAA716x_PTAB_SIZE	(SAA716x_PAGE_SIZE / 8)
...
extern int saa716x_allocate_ptable(struct saa716x_dmabuf *dmabuf);
extern void saa716x_free_ptable(struct saa716x_dmabuf *dmabuf);
extern void saa716x_dmabuf_sgpagefill(struct saa716x_dmabuf *dmabuf, struct scatterlist *sg_list, int nents, int offset);
