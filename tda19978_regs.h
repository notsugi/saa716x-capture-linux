...
/* Known registers for TDA19978 */
/* Page 0x00 - General Control */
#define REG_VERSION		0x0000
#define REG_V_PER		0x0019
#define REG_H_PER		0x001C
#define REG_HS_WIDTH		0x001E
#define REG_VDP_CTRL		0x0080
#define REG_VDP_MATRIX		0x0081
#define REG_VHREF_CTRL		0x00A0
#define REG_PXCNT_PR		0x00A1
#define REG_PXCNT_NPIX		0x00A2
#define REG_LCNT_PR		0x00A4
#define REG_LCNT_NLIN		0x00A5
#define REG_HREF_S		0x00A7
#define REG_HREF_E		0x00A9
#define REG_VREF_F1_S		0x00AD
#define REG_VREF_F1_WIDTH	0x00AF
#define REG_VREF_F2_S		0x00B0
#define REG_VREF_F2_WIDTH	0x00B2
#define REG_FREF_F1_S		0x00BF
#define REG_FREF_F2_S		0x00C0
#define REG_FDW_S		0x00D4
#define REG_FDW_E		0x00D6
...
/* Page 0x11 */
#define AVI_IF			0x1180
#define SPD_IF			0x1191
#define AUD_IF			0x1172
...
#if 0
/* TDA1997x registers from tda1997x_regs.h */
/* Page 0x00 - General Control */
#define REG_VERSION		0x0000
